#!/bin/bash
# Evaluate faithfulness for MNIST dataset
#
# Usage:
#   ./scripts/eval_mnist.sh           # Parallel by condition (2 jobs)
#   ./scripts/eval_mnist.sh --serial  # Sequential
...
echo "=========================================="
echo "Checkpoint Faithfulness: MNIST Evaluation"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "MNIST evaluation complete!"
echo "=========================================="
