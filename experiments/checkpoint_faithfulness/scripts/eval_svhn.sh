#!/bin/bash
# Evaluate faithfulness for SVHN dataset
#
# Usage:
#   ./scripts/eval_svhn.sh           # Parallel by condition (2 jobs)
#   ./scripts/eval_svhn.sh --serial  # Sequential
...
echo "========================================"
echo "Checkpoint Faithfulness: SVHN Evaluation"
echo "========================================"
