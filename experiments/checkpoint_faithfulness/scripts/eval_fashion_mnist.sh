#!/bin/bash
# Evaluate faithfulness for Fashion-MNIST dataset
#
# Usage:
#   ./scripts/eval_fashion_mnist.sh           # Parallel by condition (2 jobs)
#   ./scripts/eval_fashion_mnist.sh --serial  # Sequential
...
echo "================================================"
echo "Checkpoint Faithfulness: Fashion-MNIST Evaluation"
echo "================================================"
...
echo ""
echo "================================================"
echo "Fashion-MNIST evaluation complete!"
echo "================================================"
